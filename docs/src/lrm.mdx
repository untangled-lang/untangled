...
{/* TODO: “This definition is pretty difficult to read, would love if this was broken down a bit simpler.” */}
...
{/* TODO: This definition is not given in context. At this point, I don't know what an expression or statement is in your language, so this semantic detail could definitely wait until those things are defined. */}
<a id="current-thread">
...
{/*
  * TODO: Talk about how arrays / threads are initialized with default values when
  * users declare a tuple without assignments.
  * TODO: The default vlaues can't have void / thread as part of the types
  */}
...
{/* TODO: - Talk about undefined behavior if message are sent with undefined values */}
...
{/* TODO: - Tuple literal can't store a function that returns void */}
...
{/* TODO: - Array literal can't store a function that returns void */}
...
{/* TODO: “How do these differ between integer and floating-point operands? For instance, what does `3 / 2` do?” */}
{/*
  * TODO: - ** only supports integer exponent
  */}
Additionally, <T>**</T> raises the left operand to the power of the right operand. The comparison
operators <T>&lt;</T>, <T>&lt;=</T>, <T>&gt;</T>, and <T>&gt;=</T> compare their operands and
evaluate to a boolean value. For integers, <T>%</T> performs the “modulo” operation.
...
{/*
  * TODO: - Talk about how we can also do tuple deconstruction
  * (int i, float f) = (0, 5.0)
  */}
...
{/*  * TODO: - We're not enforcing exhaustive pattern matching
  * TODO: -We require that each pattern must have a wildcard
  */}
...
pattern [matches](#pattern-matching-semantics) every possible <NT>type</NT> in Untangled. The
compiler checks this constraint for each receive statement.
...
{/* TODO: ^ “You already define semantics for a block! You should rely on that here, since they are the same” */}
...
{/*
  * TODO: - Add semantics about semantically waiting until all threads complete
  */}
...
{/*
  ...
  * TODO: - Tuple are passed by reference b.c it's a immutable
  */}
