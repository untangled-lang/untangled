...
The compiler raises an error if the name being declared has already been declared in the current
<NT>block</NT> (but re-declaration of variables in nested blocks is allowed; see [Local
